...
program_14和program_15无法从富集分析结果得到明确定义。<br>
作者根据: 

1. program_14中有AT1 marker genes: Hopx, Pdpn; 
2. AT2 marker genes也在program_14 high activated cells表达; 

认为program_14为"Mixed AT1/AT2 state"。可以认为是AT1和AT2的共同的祖细胞状态。 
