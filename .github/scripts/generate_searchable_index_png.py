...
<div style="font-family: sans-serif; max-width: 800px; margin: 2em auto; padding: 1em; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
    ...
    <p>This repository (<strong>FigureYapy</strong>) is part of the <strong>FigureYa</strong> project and contains analyses and visualizations that require <strong>Python</strong>. For analyses that do not require Python (primarily using R), please visit the main FigureYa repository: <a href="https://ying-ge.github.io/FigureYa" target="_blank">https://ying-ge.github.io/FigureYa</a></p>
    <hr>
    <h2>How to Use This Page</h2>
    <ul>
        <li><strong>Search Everything:</strong> Use the <strong>search box below</strong> to perform a full-text search across all reports. You can look for a gene name, a specific analysis, or any other keyword.</li>
    ...
    <p>All input files, analysis code (ipynb), and results are publicly available in the <a href="https://github.com/ying-ge/FigureYapy/" target="_blank">main GitHub repository</a>. You can browse the files online or download them for offline use.</p>
<h2>Citation</h2>
